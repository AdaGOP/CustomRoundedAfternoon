Pod::Spec.new do |spec|
  ...
  spec.name         = "CustomRoundedZeinFramework"
  spec.version      = "0.0.1"
  ...
  spec.homepage     = "https://github.com/AdaGOP/CustomRoundedAfternoon"
  ...
  spec.author             = { "zeinrezky" => "zeinrezky@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/AdaGOP/CustomRoundedAfternoon.git", :tag => "#{spec.version}" }

  # Replace value of source file with your Path
  spec.source_files  = "CustomRoundedZeinFramework/**/*.{swift}"
